...
import { MessagePropsType } from '@/lib/types/message'
const click = (params: MessagePropsType) => {
...
<template>
    <div class="flex flex-1 wrap">
        <p-button type="warning" @click="click({ duration: 55000 , message: '这是一段提示消息~',position:'top'})">top</p-button>
