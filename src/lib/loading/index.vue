...
<template>
  <div class="sk-scale p-loading" :style="'width:'+size+'px;height:'+size+'px;'" v-if="type==='scale'" :class="color">
  ...
  <div class="sk-fading-circle p-loading" :style="'width:'+size+'px;height:'+size+'px;'" v-else-if="type==='fade'" :class="color">
